...
const ImageResize = ({ imageUrl, width, height, mapName, areas }) => {
  ...
  return (
    <div style={{ maxWidth: "1222px", width: "100%", margin: "0 auto" }}>
      <img
        ref={imageRef}
        src={imageUrl}
        useMap={`#${mapName}`}
...
const ImageMap = () => {
  const imageMapData = {
    imageUrl: "https://site-assests.s3.amazonaws.com/powerpuff-girls.fw.jpg",
    width: 1024,
    height: 768,
    mapName: "powerpuffgirls",
    areas: [
      {
        shape: "poly",
        coords:
          "122,36,281,36,285,37,287,39,289,42,289,47,289,48,278,77,276,81,274,84,271,85,218,85,218,90,210,90,208,95,207,99,204,100,72,100,26,87,23,84,20,81,19,76,35,40,37,38,43,35,62,35,65,30,68,26,72,25,115,25,119,27,121,30,122,36",
        href: "#ppg",
      ...
      },
      {
        shape: "poly",
        coords:
          "864,668,912,650,922,668,971,667,973,718,981,722,985,729,988,731,1010,731,1010,742,833,742,833,730,865,730,865,721,874,721,874,718,864,668",
        href: "#cn",
        alt: "Cartoon Network",
      },
      {
